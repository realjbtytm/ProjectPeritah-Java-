...
import ga.raindrop.projectperitah.information.battleSystem;
...
public class saveGame {
    ...
    public static void saveJSON() throws JSONException {
        ...
        playerInfo.put("Escaped Successfully", battleSystem.escapeSuccesses);
        Player.playerName = "";
        Player.playerHP = 100;
        Player.playerEXP = 0;
        Player.playerLevel = 1;
        battleSystem.escapeSuccesses = 0;
        ...
        playerInventory.put("Spear", Player.spear);
        playerInventory.put("Lance", Player.lance);
        ...
        try{
            FileWriter file = new FileWriter("./savegame.json");
